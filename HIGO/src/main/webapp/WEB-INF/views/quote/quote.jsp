    ...
    <div class="row no-gutters">
      ...
      <div class="col-lg-4 col-sm-6 author-block">
        <div class="author-card text-center">
          ...
          <img class="author-image" src="${ pageContext.request.contextPath }/resources/images/john-doe.jpg">
      ...
      <div class="col-lg-4 col-sm-6 author-block">
        <div class="author-card text-center">
          ...
          <img class="author-image" src="${ pageContext.request.contextPath }/resources/images/kate-stone.jpg">
